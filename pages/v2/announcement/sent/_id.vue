        ...
        <div class="bg-white rounded-md p-4 mb-4">
          <div class="flex justify-between mb-4">
            <div class="flex items-center justify-center">
              ...
              <div>
                <p class="text-[16px] font-medium text-black leading-5 mb-1 line-clamp-1">{{ detail.STUDENT_NAME }}</p>
          ...
          <div class="flex items-center justify-between relative mb-2">
            <div class="flex items-center">
              ...
              <div class="flex items-center mr-4">
                ...
                <span class="text-sm">{{ detail.VIEW_COUNT }}</span>
              </div>
            </div>
          ...
          <div v-if="comments">
            ...
            >
              ...
              <div class="ml-[38px]">
                ...
                <p class="text-gray-2">{{ cmt.CONTENT }}</p>
              </div>
            </div>
          </div>
        </div>
        <div v-if="detail.CAN_COMMENT" class="w-full h-16 bg-white absolute bottom-0 left-0 p-4 flex">
